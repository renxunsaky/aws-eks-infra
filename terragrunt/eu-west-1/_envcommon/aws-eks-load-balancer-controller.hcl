...
locals {
  base_source_url = "git::https://github.com/lablabs/terraform-aws-eks-load-balancer-controller.git"
...
inputs = {
  ...
  helm_description                 = "Terraform deployed helm release for AWS EKS load balancer controller"
